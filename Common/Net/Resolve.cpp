...
#if !PPSSPP_PLATFORM(SWITCH) && ((__GLIBC__ > 2) || (__GLIBC__ == 2 && __GLIBC_MINOR__ >= 3) || (__ANDROID_API__ >= 24)) // getifaddrs first appeared in glibc 2.3, On Android officially supported since __ANDROID_API__ >= 24
